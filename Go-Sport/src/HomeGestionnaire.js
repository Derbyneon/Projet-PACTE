...
function HomeGestionnaire({ user }) {
  ...
  return (
    <div id="home__cl" className="home__cl">
      <Nav 
        links={[
          {href: "EquipmentClientDiv", text: "Les entraineurs et les clients", onClick: () => setPage("EquipmentClientDiv")},
          {href: "EntraineurAbonnementDiv", text: "Les equipements et les abonnements", onClick: () => setPage("EntraineurAbonnementDiv")},
